...
@export var player_powerups: Array[InventoryPowerup]
@export var powerups_in_use: Dictionary = {"Player" = [], "BasicBall" = [], "KnockbackBall" = [], "SmashBall" = [], "StickBall" = [], "MoveBall" = [], "BounceBall" = [], "LargeLight" = [], "DashBall" = []}

var powerups_in_use_ui: Dictionary = {"Player" = [], "BasicBall" = [], "KnockbackBall" = [], "SmashBall" = [], "StickBall" = [], "MoveBall" = [], "BounceBall" = [], "LargeLight" = [], "DashBall" = []}
